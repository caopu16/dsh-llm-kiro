 ...
 */
export async function post(options: TransportRequest): Promise<TransportResponse> {
...
export async function postJson(
  ...
  try {
    ...
    // The status alone identifies a failure whose body is not JSON (a proxy
    // error page, an empty 5xx); callers report on status in that case.
